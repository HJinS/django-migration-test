...
class SquashTestSample(TestCase):
    """
    ...
    def test_migration_names_set_order_succeeds(self, result: Queue):
        """
        ...
        test_results["CircularDependencyErrorRaised"] = {
            "value": raised,
        ...
        test_results["migrationImportOrderValue"] = {
            "imported": imported_order,
            "expected": expected_order,
            "msg": ""
        }
        result.put(test_results)
